...
def plot_reward():
    reward_hard_bs = np.load('/home/zongshi/MARL_CAVs_2/MARL/results/Aug_29_11_10_47/eval_rewards.npy')
    ...
    plt.savefig("/home/zongshi/MARL_CAVs_2/MARL/common/learning_curve.png" , dpi=400, bbox_inches="tight")
    plt.show()
